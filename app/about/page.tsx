  ...
  const quotePool = useMemo(
    () => [
      ...
      },
      {
        ...
        en: '"Decision Cat won\'t decide for you. It just stays close while your thoughts untangle."',
      },
      {
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 
                  ...
                  style={{ fontFamily: titleFont }}
                >
                  {t("小猫不替你做决定", "Decision Cat Won't Decide for You")}
                </h2>
                <p className="text-muted-foreground leading-relaxed" style={{ fontFamily: bodyFont }}>
                  {t(
                    ...
                    "This isn't a tool that spits out the 'correct answer!' Decision Cat doesn't pretend to know what's absolutely right. It's just a cat, meow! What it can do is offer one tiny reason when you're stuck! Maybe that little reason lands exactly where your heart was already leaning."
                  )}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 
                  ...
                  style={{ fontFamily: titleFont }}
                >
                  {t("它会陪你把想法理顺", "Decision Cat Stays With You and Untangles Your Thoughts")}
                </h2>
                <p className="text-muted-foreground leading-relaxed" style={{ fontFamily: bodyFont }}>
                  {t(
                    "有时候你纠结的并不是答案，而是连问题都还没长清楚。当你还说不出准确的两个选项时，小猫会先帮你把那团模糊的念头收一收，整理成两个可以真正拿来选的方向。",
                    "Sometimes the real issue isn't the answer! It's that the question itself is still fuzzy. If you can't name two clear options yet, Decision Cat helps gather those messy thoughts first and lay them out as two paths you can actually choose between! A tidy little meow-style cleanup!"
                  )}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 
                  ...
                  style={{ fontFamily: titleFont }}
                >
                  {t("它目前最擅长二选一", "Right Now, Decision Cat Is Best at Two-Option Choices")}
                </h2>
                <p className="text-muted-foreground leading-relaxed" style={{ fontFamily: bodyFont }}>
                  {t(
                    "小猫的能力范围有限。它最擅长的是在A和B之间帮你看看。如果你的问题更复杂，可以先用「帮你理清」功能，把一团纠结整理成两个方向，然后再让小猫来帮忙。",
                    "Decision Cat has limited abilities! It's best at helping you see between A and B. If your problem is more complex, try 'Help Me Clarify' first to sort your tangle into two directions, then let Decision Cat help, meow!"
                  )}
                </p>
              </div>
            </div>
